...
namespace UPM_IPS.JRPPCLMCFProyectoIPS
{
	...
	/// </summary>
	internal partial class JRPPCLMCFProyectoIPSCommandSet : JRPPCLMCFProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSCommandSet.
		/// </summary>
		public JRPPCLMCFProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class JRPPCLMCFProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSCommandSetBase.
		/// </summary>
		protected JRPPCLMCFProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewJRPPCLMCFProyectoIPSExplorerCommand,
				typeof(JRPPCLMCFProyectoIPSEditorFactory).GUID);
		...
		{
			JRPPCLMCFProyectoIPSExplorerToolWindow explorer = this.JRPPCLMCFProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected JRPPCLMCFProyectoIPSDocData CurrentJRPPCLMCFProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as JRPPCLMCFProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected JRPPCLMCFProyectoIPSDocView CurrentJRPPCLMCFProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as JRPPCLMCFProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected JRPPCLMCFProyectoIPSExplorerToolWindow JRPPCLMCFProyectoIPSExplorerToolWindow
		{
			get
			{
				JRPPCLMCFProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(JRPPCLMCFProyectoIPSExplorerToolWindow), true) as JRPPCLMCFProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				JRPPCLMCFProyectoIPSExplorerToolWindow explorerWindow = this.JRPPCLMCFProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class JRPPCLMCFProyectoIPSClipboardCommandSet : JRPPCLMCFProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSClipboardCommandSet.
		/// </summary>
		public JRPPCLMCFProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class JRPPCLMCFProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected JRPPCLMCFProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
