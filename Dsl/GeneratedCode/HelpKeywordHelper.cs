...
namespace UPM_IPS.JRPPCLMCFProyectoIPS
{
	...
	/// </remarks>
	public partial class JRPPCLMCFProyectoIPSHelpKeywordHelper : JRPPCLMCFProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected JRPPCLMCFProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JRPPCLMCFProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static JRPPCLMCFProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JRPPCLMCFProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JRPPCLMCFProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected JRPPCLMCFProyectoIPSHelpKeywordHelperBase()
			: base() { }
